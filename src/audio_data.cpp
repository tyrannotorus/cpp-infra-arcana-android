...
static const StrToSfxIdMap s_str_to_sfx_id_map = {
        ...
        {"ape", audio::SfxId::ape},
        {"alchemy_rummage", audio::SfxId::alchemy_rummage},
        {"bookshelf_rummage", audio::SfxId::bookshelf_rummage},
        {"cabinet_open", audio::SfxId::cabinet_open},
...
static const SfxIdToStrMap s_sfx_id_to_str_map = {
        ...
        {audio::SfxId::ape, "ape"},
        {audio::SfxId::alchemy_rummage, "alchemy_rummage"},
        {audio::SfxId::bookshelf_rummage, "bookshelf_rummage"},
        {audio::SfxId::cabinet_open, "cabinet_open"},
