...
static std::string get_user_dir_from_sdl_pref_path()
{
        TRACE_FUNC_BEGIN;
...
{
        const std::string sdl_pref_path = get_user_dir_from_sdl_pref_path();
...
void init()
{
        ...
        if (user_dir.empty()) {
                ...
                user_dir = get_user_dir_from_sdl_pref_path();
